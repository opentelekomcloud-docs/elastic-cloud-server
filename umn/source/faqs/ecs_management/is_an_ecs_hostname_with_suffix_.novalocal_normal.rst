...
If you do not need suffix **.novalocal** in obtained hostnames, change the hostnames. For details, see `How Can a Changed Static Hostname Take Effect Permanently? <faqs/ecs_management/how_can_a_changed_static_hostname_take_effect_permanently>`__
