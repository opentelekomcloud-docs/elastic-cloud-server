...
Enabling ECS virtual memory will deteriorate I/O performance. If the memory size of an ECS is insufficient, you are advised to increase its memory size by referring to :ref:`Modifying ECS Specifications <en-us_topic_0030828258>`. If you really need to enable virtual memory, see the operations described below.
