...
#. Set the automatic startup of iptables.
...
#. Check whether IP forwarding is enabled on the proxy ECS.
   ...
   **cat /proc/sys/net/ipv4/ip_forward**
   ...
   -  If **0** (disabled) is displayed, go to :ref:`13 <en-us_topic_0027157850__li51820417113959>`.
   -  If **1** (enabled) is displayed, go to :ref:`18 <en-us_topic_0027157850__li33604568113959>`.
...
#. .. _en-us_topic_0027157850__li33604568113959:
   ...
   Configure default iptables rules.
