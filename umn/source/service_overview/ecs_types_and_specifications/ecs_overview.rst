...
The cloud platform provides multiple ECS types for different compute and storage capabilities. One ECS type provides various flavors with different vCPU and memory configurations for you to select.
