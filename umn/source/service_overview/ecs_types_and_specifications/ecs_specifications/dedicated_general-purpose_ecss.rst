...
X2e ECSs use the second-generation Intel® Xeon® Scalable processors to provide powerful and stable compute performance. By using 25GE high-speed intelligent NICs, X2e ECSs offer ultra-high network bandwidth and PPS.
...
-  X2e ECSs are suitable for:

   -  Websites and web applications that require high compute and network performance
...
.. table:: **Table 1** X2e ECS specifications
...
.. table:: **Table 2** C9 ECS specifications
...
.. table:: **Table 3** C7n ECS specifications
...
.. table:: **Table 4** C7t ECS specifications
...
.. table:: **Table 7** X1e ECS specifications
...
:ref:`Table 8 <en-us_topic_0091224748__table192771727112217>` lists the OSs supported by dedicated general-purpose ECSs.
