...
.. table:: **Table 1** Linux ECS login modes
   ...
   |        |          |   <instances/logging_in_to_a_linux_ecs/login_using_an_ssh_password#EN-US_TOPIC_0017955633__section62068112020>`__    |                                  |
   |        |          | - Key-pair-authenticated: `Logging In to the Linux ECS from Local Windows                                            |                                  |
   |        |          |   <instances/logging_in_to_a_linux_ecs/login_using_an_ssh_key#EN-US_TOPIC_0017955380__section47918167111724>`__      |                                  |
   +--------+----------+----------------------------------------------------------------------------------------------------------------------+----------------------------------+
   |        | Linux    | Run commands.                                                                                                        |                                  |
   |        |          |                                                                                                                      |                                  |
   |        |          | - Password-authenticated: `Logging In to the Linux ECS from a Local Linux Server                                     |                                  |
   |        |          |   <instances/logging_in_to_a_linux_ecs/login_using_an_ssh_password#EN-US_TOPIC_0017955633__section20811823174313>`__ |                                  |
   |        |          | - Key-pair-authenticated: `Logging In to the Linux ECS from Local Linux                                              |                                  |
   |        |          |   <instances/logging_in_to_a_linux_ecs/login_using_an_ssh_key#EN-US_TOPIC_0017955380__section3666784111724>`__       |                                  |
   +--------+----------+----------------------------------------------------------------------------------------------------------------------+----------------------------------+
   |        | Windows  | Use the remote login function available on the management console.                                                   | No EIP is required.              |
   |        |          |                                                                                                                      |                                  |
   |        |          | `Login Using VNC <instances/logging_in_to_a_linux_ecs/login_using_vnc>`__                                            |                                  |
   +--------+----------+----------------------------------------------------------------------------------------------------------------------+----------------------------------+
