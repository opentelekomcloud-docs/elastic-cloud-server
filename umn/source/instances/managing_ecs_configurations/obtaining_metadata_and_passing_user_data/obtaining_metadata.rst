...
.. table:: **Table 1** ECS metadata types
   ...
   |                       |                                        |                                                                                                                                                                |
   |                       |                                        | This metadata allows you to specify scripts and configuration files for initializing ECSs. For details, see :ref:`Passing User Data <en-us_topic_0032380449>`. |
   |                       |                                        |                                                                                                                                                                |
