...
.. table:: **Table 1** ECS metadata types
   ...
   |                       |                                        |                                                                                                                                                                  |
   |                       |                                        | This metadata allows you to specify scripts and configuration files for initializing ECSs. For details, see :ref:`Injecting User Data <en-us_topic_0032380449>`. |
   |                       |                                        |                                                                                                                                                                  |
   ...
   +-----------------------+----------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | EC2-compatible        | /meta-data/local-ipv4                  | Displays the fixed IP address of an ECS.                                                                                                                         |
   |                       |                                        |                                                                                                                                                                  |
   ...
   +-----------------------+----------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | EC2-compatible        | /meta-data/public-ipv4                 | Displays the EIP bound to the ECS.                                                                                                                               |
   |                       |                                        |                                                                                                                                                                  |
