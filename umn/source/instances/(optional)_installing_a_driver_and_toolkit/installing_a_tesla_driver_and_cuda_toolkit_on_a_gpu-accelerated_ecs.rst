...
#. On the CUDA download page, set parameters according to the information shown in `Obtaining a Tesla Driver and CUDA Toolkit <../../instances/(optional)_installing_a_driver_and_toolkit/obtaining_a_tesla_driver_and_cuda_toolkit.html>`__.\ **Figure 16** Selecting a CUDA version
   |image18|
...
9.  Select **Install** and press **Enter** to start the installation.\ **Figure 21** Installing CUDA_2
    |image23| **Figure 22** Completing the installation
    |image24|
...
#. Log in to the ECS.
#. On the CUDA download page, set parameters according to the information shown in `Downloading a CUDA Toolkit <../../instances/(optional)_installing_a_driver_and_toolkit/obtaining_a_tesla_driver_and_cuda_toolkit.html#EN-US_TOPIC_0213874991__section10203125783920>`__.\ **Figure 25** Selecting a CUDA version
   |image27|
